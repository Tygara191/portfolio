...
$lang['nuvolo_body'] = 'I currently work at <a href="https://www.nuvolo.com/" target="_blank">Nuvolo</a> to maintain the company\'s Real Estate Asset Management solution. My main day-to-day work includes developing and maintaining backend business logic, hosted by <a href="https://www.servicenow.com/" target="_blank">ServiceNow</a> and also a frontend interface powered by React.';
$lang['graosoft'] = "Graosoft";
$lang['graosoft_position'] = "Chief Technology Officer (CTO)";
$lang['graosoft_body'] = 'My work at <a href="https://graosoft.com/" target="_blank">Graosoft</a> includes but is not limited to development, solving technical problems, planning the architectural direction of projects, supporting members of the technical team, reviewing and providing feedback for their technical implementations.';
$lang['noit'] = "NOIT";
...
$lang['skills_codeigniter'] = "I am comfortable with the framework and like using it. I've done 2 noteworthy projects in the past. The backend of the \"Подсети ме!\" android app, which I competed with at ".$lang['NOIT_link_full']." 2017 and another more complex project for a private client that I cannot discuss further due to an NDA.";
